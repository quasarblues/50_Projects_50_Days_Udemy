...
When a user clicks the 'Show Notification' button, a toast appears on the bottom right side of the screen. Toasts are removed after a set amount of time passes.
