# 50 Projects in 50 Days: Live User Filter
...
This app uses the Random User API to generate 50 random users. We can use the search bar to sort through the users.
