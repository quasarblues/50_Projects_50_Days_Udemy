# 50 Projects in 50 Days: Pokedex
...
This project uses the PokeApi to show data about Pokemon. 

I modified the project by showing if a Pokemon has dual types. Also the background color of the Pokemon card shows dual typing as well.
