# 50 Projects in 50 Days: Verify Account
...
This is a UI for a user to input an account verification code.

The event listener 'keydown' and the focus() method are occur before the browser has time to update the user's input. So we use setTimeout to give the browser time to handle this.
