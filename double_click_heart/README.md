...
When a user double clicks the image, a heart icon quickly appears then disappears. We wrote our own function to check for a double click instead of using the standard 'dblclick' event listener.
