...
This app matches an image on the right side of the screen with an image on the left side of the screen. Users can click the up arrow or down arrow to cycle between images and their corresponding description.
