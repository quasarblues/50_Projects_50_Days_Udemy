# 50 Projects in 50 Days: Password Strength Background
...
There's a blurry background image. The image gets clearer as the user creates a longer password. So far it's only based on the length of the password.
